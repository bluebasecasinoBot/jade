...
__sS([
    {
        ...
        style:{
            height:'100vh',
            width:'100vw',
            background:'linear-gradient(#b93327, #d03e27)',
    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:'height:fit-content;width:100%;padding:50px;border-top:5px solid #aa1409;background:#c01d11;display:flex;align-items:center;flex-direction:column;'
                },
                [
                    __c('p',{style:'font-size: .9rem;font-family:ubuntu;line-height: 1.75rem;text-align:center;font-weight:900;color:#fff;width:100vw'},[
                        '© 2024 All Right Reserved by $JADE'
                    ])
                ]
            )
        ],
    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`min-height:${__p(['navBar','l_size'],'120px')};min-width:${__p(['navBar','l_size'],'120px')};border-radius:unset;background-image:url('./assets/logo.png');background-color:transparent;`
                },[],{genericStyle:['bg_fit']}
            ),
            __c(
                'div',
                ...
                [
                    __SYD.nav_b_text('Who is $JADE?','_p3'),
...
__SYD.buyNowBtn = () =>{
    return __c('a',{href:'https://suntzutrx.xyz/',target:'blank',style:`display:${__p(['navBar','__nav_d'],'flex')};align-items:center;justify-content:center;padding:15px 30px;color:#fff;text-decoration:none;`,class:'btn_buy'},['Buy Now'],{genericStyle:['bg_fit']})
}
...
__SYD.mobileMenu = () =>{
    return __c(
        'div',
        {
            style:`height:fit-content;width:fit-content;padding:20px 10px;display:${__p(['mobileMenu','_d'],'none')};flex-direction:column;row-gap:20px;background:#f0472f;border:2px solid #791102;border-left:5px solid #791102;border-bottom:5px solid #791102;border-radius:15px;border-top-right-radius:unset;border-bottom-right-radius:unset;position:absolute;top:100%;right:0;opacity:${__p(['mobileMenu','_op'],'0')};transition:opacity .3s linear`,
            tabindex:'1',
            class:'mobile_menu'
        },
        [
